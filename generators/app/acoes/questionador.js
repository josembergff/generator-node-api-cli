  ...
  return atual.prompt([
    {
      ...
      name: 'nomeProjeto',
      message:
        'Qual o nome deste novo projeto API em Node com Mongoose (sem acentos, somente em minúsculas, espaços e caracteres especiais):',
      default: 'novoprojeto'
    },
    {
      type: 'input',
      ...
      message:
        'Qual o nome externo deste novo projeto API em Node com Mongoose:',
